  ...
  return (
    <div className="  flex flex-col p-4 gap-4 w-full items-center">
      ...
      <div className="mt-16 flex flex-col w-full gap-2">
        <h1 className=" font-bold text-lg tracking-wide">Completed Tasks</h1>
      {
        isloadingTasks ? "Loading tasks..." : isErrorTasks ? "Something went Wrong" : (
          completedTasks.map((task) => (
            
              <div key={task._id} className=" relative flex flex-col items-center gap-2 w-full px-2 md:px-4 py-4 border-[1px] border-gray-300 rounded-lg">
