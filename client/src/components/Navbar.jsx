      ...
      <div className="flex px-4 w-full justify-center h-full bg-white border-b-[1px] border-gray-300">
        <div className=" relative flex gap-2 w-full max-w-[1240px] items-center justify-between">
          ...
          <div className="flex gap-2 items-center">
            <Link to="/login">
              <button className="hidden md:block whitespace-nowrap border-[1px] border-blue-600 px-4 py-2 rounded-md font-semibold bg-white text-blue-600 hover:opacity-50 active:opacity-20 ease-in-out duration-200 transition-all">Log in</button>
            </Link>
